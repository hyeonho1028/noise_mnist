...
def main():
    ...
    train_df = pd.read_csv('../data_2/dirty_mnist_answer.csv')
    idx = [i[-5:] for i in ['0000'+i for i in train_df['index'].astype(str)]]
    image_path = np.array([os.path.join('../data_2/dirty_mnist/', f'{i}.png') for i in idx])
